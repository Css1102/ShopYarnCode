...
localStorage.setItem("input",JSON.stringify({...formInput}))
  ...
  if(signObj.name===formInput.name && signObj.email===formInput.email && signObj.password===formInput.password ){
  navigate("/login")
  }
  // else{
...
<input type="email" name='email'  placeholder='Email adress' value={formInput.email} onChange={(e)=>setformInput({...formInput,[e.target.email]:e.target.value})}/>
<input type="password" name='current-password'  placeholder='Password' value={formInput.password} onChange={(e)=>setformInput({...formInput,[e.target.password]:e.target.value})}/>
  {/* </div> */}
